# CIS - Cooperation Education Management System
 ...
 #### **ดังนั้น** ทางกลุ่มจึงได้จัดทำระบบ CIS Cooperative Education Management เพื่อช่วยให้นักศึกษา อาจารย์ และเจ้าหน้าที่ สามารถเข้าถึงข้อมูลในการสืบค้น หรือการจัดการข้อมูลที่เกี่ยวกับสหกิจศึกษาได้สะดวก รวดเร็ว และเห็นภาพรวมได้มากขึ้น แต่ในระบบนี้ทางกลุ่มได้จัดทำระบบในส่วนของนักศึกษา ตั้งแต่การเข้าสู่ระบบ การค้นหาสถานประกอบการ และรายละเอียดของงานในตำแหน่งนั้น ๆ และในส่วนของเจ้าหน้าที่ ตั้งแต่การเข้าสู่ระบบ จัดการกับข้อมูลของนักศึกษา การจัดการสถานประกอบการในการเพิ่ม แก้ไข และลบข้อมูลของสถานประกอบการ 
